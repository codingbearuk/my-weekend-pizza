...
var createNewMessage = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, email, subject, message, newMessage, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, name = _a.name, email = _a.email, subject = _a.subject, message = _a.message;
                    newMessage = new message_model_1.default({ name: name, email: email, subject: subject, message: message, new: true });
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
