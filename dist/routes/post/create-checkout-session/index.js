...
var createCheckoutSession = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var stripe, price, cart, id, address, deliveryDate, document, orderToSave, session;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                stripe = require('stripe')(process.env.STRIPE_SK);
                price = Math.round(req.body.amount.toFixed(2) * 100);
                cart = req.body.cart;
                id = uuid_1.v4();
                ...
                orderToSave = new order_model_1.default(document);
                return [4 /*yield*/, orderToSave.save()];
            case 1:
                _a.sent();
