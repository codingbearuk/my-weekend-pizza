const returnHTML = (name: string): string => `
<!DOCTYPE html>
<html ⚡4email>
  <head>
    <meta charset="utf-8" />
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="530" valign="top" align="center">
                              <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td class="es-m-txt-l es-p15t" align="left"><h3>Hello ${name},</h3></td>
                                </tr>
                                <tr>
                                  <td class="es-p15t es-p10b" align="left">
                                    <p
                                      ...
                                      "
                                    >
                                      Welcome to My weekend Pizza and thanks for signing up! You're one step
                                      closer to get one of our tasty pizzas that we offer.
                                    </p>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td class="es-p15t" align="center">
                                    <p style="font-size: 16px; color: #777777">
                                      follow the link below to place your
                                    </p>
                                    <p style="font-size: 16px; color: #777777">
                                      first pizza order with us&nbsp;
                                    </p>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="es-p30t es-p15b" align="center">
                                    <span class="es-button-border" style="background: #f6a95f"
                                      ><a
                                        href="http://vps-a3dcf2e1.vps.ovh.net:3030/"
                                        class="es-button"
                                        target="_blank"
                                        style="
                                          font-weight: normal;
